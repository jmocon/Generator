...
class Part{
	...
	public function IsExist($mdl){
		...
		if($rows[0] > 0)
		{
			$msg .= "<p><a href='javascript:void(0)' class='alert-link' onclick='setFocus(\"inputCategory_Id\")'>Category_Id</a>: " . $mdl->getCategory_Id() . "</p>";
			$val = true;
		}
		...
		if($rows[0] > 0)
		{
			$msg .= "<p><a href='javascript:void(0)' class='alert-link' onclick='setFocus(\"inputArea\")'>Area</a>: " . $mdl->getArea() . "</p>";
			$val = true;
		}
